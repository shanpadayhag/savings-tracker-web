...
// Ranks categories by amount and shows the per-category change vs. the prior
// equivalent period — the answer to "what got more / less expensive?". Sits
// next to the donut so the two read as a single unit.
              ...
              return (
                <TableRow key={category.name}>
                  ...
                  <TableCell className="text-right tabular-nums">
                    {currencyUtil.format(category.amount, reportsCurrency)}
                  </TableCell>
